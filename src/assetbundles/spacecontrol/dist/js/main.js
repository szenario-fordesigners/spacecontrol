...
const disk_total_space = Math.round(ctx.dataset.disk_total_space / 1024 / 1024);
const disk_used_space = Math.round(
	(ctx.dataset.disk_total_space - disk_free_space) / 1024 / 1024
);
